    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title d-flex justify-content-between mb-4">
                <h5>Edit Task</h5>
                <a href="{{ route('show.task') }}" class="btn btn-sm btn-rounded btn-gradient-info"><i class="mdi mdi-chart-bubble"></i> All Tasks</a>
            </div>
            <form wire:submit.prevent="editTask" enctype="multipart/form-data" class="form-horizontal row g3">
                ...
                <div class="form-group d-flex justify-content-between">
                    <button type="submit" class="btn btn-gradient-info"><i class="mdi mdi-content-save"></i> Update</button>
