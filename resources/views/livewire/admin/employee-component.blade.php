<div>
    <div class="add-emp d-flex justify-content-end mb-3">
        <a href="{{route('add.employee')}}" class="btn btn-success btn-sm"><i class="mdi mdi-account-multiple-plus "></i> Create Employee<a>
    </div>
        <div class="card">
            <div class="card-body">
                        ...
                        @if ($employees->count() > 0)
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-around">
                                    <a href="{{route('edit.employee', ['e_id' => $employee->employee_id])}}" class="btn btn-gradient-primary btn-sm">
